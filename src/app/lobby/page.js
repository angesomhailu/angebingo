...
export default async function LobbyPage() {
  ...
  try {
    ...
    activeRooms = [
      { id: 1, name: "Beginner's Luck", entryFee: 10, prize: 500, maxPlayers: 50, color: "from-emerald-500 to-teal-600", glow: "shadow-[0_0_20px_rgba(16,185,129,0.3)]", hot: false },
      { id: 2, name: "Midnight Madness", entryFee: 50, prize: 3000, maxPlayers: 50, color: "from-fuchsia-500 to-purple-600", glow: "shadow-[0_0_20px_rgba(192,38,211,0.3)]", hot: true },
      { id: 3, name: "High Roller VIP", entryFee: 500, prize: 50000, maxPlayers: 25, color: "from-yellow-400 to-amber-600", glow: "shadow-[0_0_20px_rgba(250,204,21,0.3)]", hot: false },
      { id: 4, name: "Speed Daub", entryFee: 25, prize: 1000, maxPlayers: 100, color: "from-cyan-400 to-blue-600", glow: "shadow-[0_0_20px_rgba(34,211,238,0.3)]", hot: false }
    ];
  }

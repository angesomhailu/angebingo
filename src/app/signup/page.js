  ...
  return (
    <div className="min-h-[calc(100vh-80px-200px)] flex items-center justify-center py-20 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-slate-900/60 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -top-24 -left-24 w-48 h-48 bg-fuchsia-500/30 rounded-full blur-[50px] -z-10 pointer-events-none"></div>
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Join AngeBingo and start playing today
          </p>
        </div>
        ...
        <form className="mt-8 space-y-5" onSubmit={handleSignup}>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-slate-300">
              I agree to the <Link href="/services" className="text-fuchsia-400 hover:text-fuchsia-300">Terms of Service</Link> and <Link href="/privacy" className="text-fuchsia-400 hover:text-fuchsia-300">Privacy Policy</Link>
            </label>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-slate-900/80 text-slate-400 backdrop-blur-sm rounded-md">Or sign up with</span>
            </div>
          </div>
